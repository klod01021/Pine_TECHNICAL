...
- When a move could be read either as A-B-C or as the first three waves of a new impulse, the lower degree decides it: a leg that subdivides into five sub-waves is impulsive, one that subdivides into three is corrective. This uses the lower degree even when you have its labels switched off, so **Lower degree size** changes your counts either way.
